...
class AABox {
  ...
  void init_to( const Scalar* points, unsigned int size ) ;
  ...
  void fit_to( const Scalar* points, unsigned int size ) ;
  ...
  Scalar sq_distance_to( const Scalar point[Dim] ) const ;
  Scalar distance_to( const Scalar point[Dim] ) const ;
  ...
  bool clips_triangle_bbox( const Scalar* vertices
                          ) const ;
  ...
  bool triangle_intersection( const Scalar* vertices,
                              std::vector<Scalar>& output
                            ) const ;
  ...
  bool clips_triangle( const Scalar* vertices 
                     ) const ;
  ...
  //vertex array for easy mesh wrapping
  static const unsigned int single_triangle[3] ;
} ;
...
template< int Dim, typename Scalar>
const unsigned int AABox<Dim, Scalar>::single_triangle[3] = 
  {0, 1, 2} ;
